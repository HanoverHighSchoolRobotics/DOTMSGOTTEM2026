...
//         return getEncoderPositionRadians() / ClimberConstants.ROTATIONSTOMETERS;
//     }
...
//                 break;
//         }
//         SmartDashboard.putNumber("Climber Height Meters", getClimberHeightMeters());
//         SmartDashboard.putNumber("Climber Encoder Radian Reading", getEncoderPositionRadians());
//     }
...
//         setClimberVoltage(MathUtil.clamp(pid.calculate(getClimberHeightMeters(), ClimberConstants.CLAWSTOTOPMETERS),
//             -1 * ClimberConstants.MAXCLIMBVOLTS,
//             ClimberConstants.MAXCLIMBVOLTS));
//     }

//     public void pidclawstorobotliftedPeriodic(){
//         setClimberVoltage(MathUtil.clamp(pid.calculate(getClimberHeightMeters(), ClimberConstants.CLAWSTOROBOTLIFTEDMETERS),
//             -1 * ClimberConstants.MAXCLIMBVOLTS,
//             ClimberConstants.MAXCLIMBVOLTS));    
//     }

//     public void pidclawstobottomPeriodic(){
//         setClimberVoltage(MathUtil.clamp(pid.calculate(getClimberHeightMeters(), ClimberConstants.CLAWSTOBOTTOMMETERS),
//             -1 * ClimberConstants.MAXCLIMBVOLTS,
//             ClimberConstants.MAXCLIMBVOLTS));    
//     }
